...
REQUIRED_TOKENS = {
    ...
    "backend/app/api/v1/knowledge.py": ["/status", "/rebuild", "/search"],
    ...
    "backend/app/services/embedding_service.py": ["EMBEDDING_API_URL", "deterministic_16d", "embed_text"],
    ...
    "frontend/src/App.tsx": ["/auth/me", "/learning/start", "/learning-records", "learning-start-panel", "resource-gear", "数字人老师", "新创画像", "多轮对话记录"],
